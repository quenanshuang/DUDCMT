...
class DSConv1(nn.Module):
    ...
    def forward(self, f):
        ...
        input_shape = f.shape
        dsc = DSC1(input_shape, self.kernel_size, self.extend_scope, self.morph,
                  self.device)
